...
var createReactComponent = (iconName, iconNamePascal, iconNode) => {
  const Component = (0,external_C_Users_dagobah_Documents_Repos_royal_flower_website_node_modules_react_index_js_.forwardRef)(
    (_a, ref) => {
      var _b = _a, { color = "currentColor", size = 24, stroke = 2, children } = _b, rest = __objRest(_b, ["color", "size", "stroke", "children"]);
      return (0,external_C_Users_dagobah_Documents_Repos_royal_flower_website_node_modules_react_index_js_.createElement)(
        "svg",
        ...
        [...iconNode.map(([tag, attrs]) => (0,external_C_Users_dagobah_Documents_Repos_royal_flower_website_node_modules_react_index_js_.createElement)(tag, attrs)), ...children || []]
      );
    }
  );
  Component.propTypes = {
...
var IconX = (0,_createReactComponent_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)("x", "IconX", [
